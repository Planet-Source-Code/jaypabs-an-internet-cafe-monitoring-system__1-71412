VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptICMS 
   Caption         =   "ICMS Report"
   ClientHeight    =   8490
   ClientLeft      =   165
   ClientTop       =   555
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item2 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Date/Time Login"
      EndProperty
      ItemType3       =   3
      BeginProperty Item3 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Date/Time Logout"
      EndProperty
      ItemType4       =   3
   ...
   EndProperty
End
Attribute VB_Name = "rptICMS"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Private Sub DataReport_Initialize()
    Select Case Server.cboCategory.ListIndex
    Case 0, 3
        Me.Sections(1).Controls("label6").Caption = Server.cboCategory & " Report - Date: " & Server.BegDate
    Case 1, 2
        Me.Sections(1).Controls("label6").Caption = Server.cboCategory & " Report - from: " & Server.BegDate & " and " & Server.EndDate
    End Select
End Sub
